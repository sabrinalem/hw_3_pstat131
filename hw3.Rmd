...
```
Visually we can see that the variables above the diagnol from the origin are negatively correlated, while the other half of the plot shows positive correlation.age and pclass are negatively correlated, age and sib_sp are negatively correlated, age and parch are negatively correlated, sib_sp and pclass are positively correlated, fare and pclass are negatively correlated, parch and sib_sp are positively correlated, fare and sib_sp are positively correlated, and fare and parch are positively correlated.
\
\
*Question 4*
\
